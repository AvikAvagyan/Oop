...
using Oop.PrinciplesOop.Polymorphism.Abstract.Methode;
...
namespace Oop
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            ShapeAbstractMethod[] myShapes = {new HexagonAbstractMethod(), new CiricleAbstractMethod(), new HexagonAbstractMethod("Mick" ) ,
                new CiricleAbstractMethod("Beth"), new CiricleAbstractMethod("Linda" )};
